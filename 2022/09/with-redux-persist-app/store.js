...
export const actionTypes = {
  ...
  UPDATE_MATT_ITEM: 'UPDATE_MATT_ITEM'
}

// REDUCERS
export const reducer = (state = exampleInitialState, action) => {
  switch (action.type) {
    case actionTypes.UPDATE_MATT_ITEM:
      return {
        ...state,
        mattItem: action.data,
      }
...
export const changeTest = (data) => {
  return { type: actionTypes.UPDATE_MATT_ITEM, data }
}

const persistConfig = {
  key: 'primary',
  storage,
  whitelist: ['exampleData', 'testing'], // place to select which state you want to persist
}
